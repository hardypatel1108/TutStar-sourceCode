        ...
        <div className="flex h-screen w-full overflow-hidden bg-white font-sans">
            ...
            <div className="flex w-full flex-col overflow-y-auto p-8 sm:p-12 md:p-20 lg:w-1/2">
                ...
                <div className="mx-auto w-full max-w-[400px]">
                    <h1 className="mb-2 text-3xl font-bold text-[#1a1a1a] sm:text-4xl">Forgot Password</h1>
                    <p className="mb-10 text-neutral-500">Enter your email to receive a password reset link</p>

                    {status && <div className="mb-4 rounded-lg bg-green-50 px-4 py-2 text-sm font-medium text-green-600">{status}</div>}
