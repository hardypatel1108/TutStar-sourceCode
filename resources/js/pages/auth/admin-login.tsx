        ...
        <div className="flex h-screen w-full overflow-hidden bg-white font-sans">
            ...
            <div className="flex w-full flex-col overflow-y-auto p-8 sm:p-12 md:p-20 lg:w-1/2">
                ...
                <div className="mx-auto w-full max-w-[400px]">
                    ...
                    <h2 className="mb-2 text-2xl font-bold text-[#1a1a1a]">Admin Login</h2>
                    <p className="mb-10 text-neutral-500">Login to access your administrative account</p>

                    <Form {...AdminLoginController.store.form()} resetOnSuccess={['password']} className="flex flex-col gap-8">
                        {({ processing, errors }) => (
                            <>
