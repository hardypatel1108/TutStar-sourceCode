...
export default function Edit() {
    const { clazz, boards } = usePage().props as {
        clazz: {
            id: number;
            board_id: number;
            name: string;
                ...
                <Card className="p-4">
                    <div className="flex justify-center p-3">
                        <div className="w-full max-w-xl p-6">
                            <Form
                                {...ClazzController.update.form({ class: String(clazz.id) })}
                                defaults={clazz}
                                    ...
                                    <>
                                        <div className="grid grid-cols-1 gap-6">
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Select name="board_id" defaultValue={String(clazz.board_id)}>
                                                    <SelectTrigger>
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input id="name" name="name" defaultValue={clazz.name} />
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Select name="status" defaultValue={clazz.status}>
                                                    <SelectTrigger>
