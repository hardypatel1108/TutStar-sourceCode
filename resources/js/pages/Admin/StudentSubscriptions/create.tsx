...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Subscription', href: '/admin/student-subscriptions/create' },
];

export default function Create() {
    const { students, plans } = usePage().props as {
        ...
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold tracking-tight">Add Student Subscription</h1>
                ...
                <Card className="p-4">
                    <div className="flex justify-center p-3">
                        <div className="w-full max-w-xl p-6">
                            <Form
                                {...StudentSubscriptionController.store.form()}
                                resetOnSuccess
                                    ...
                                    <>
                                        <div className="grid grid-cols-1 gap-6">
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input id="start_at" name="start_at" type="date" required />
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input id="end_at" name="end_at" type="date" required />
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input id="price_paid" type="number" name="price_paid" step="0.01" min="0" />
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input id="phonepe_order_id" name="phonepe_order_id" />
