...
return new class extends Migration {
    ...
    {
        if (Schema::hasTable('checkout_offers')) {
            return;
        }
...
CREATE TABLE `checkout_offers` (
  ...
  CONSTRAINT `checkout_offers_checkout_plan_id_foreign` FOREIGN KEY (`checkout_plan_id`) REFERENCES `checkout_plans` (`id`) ON DELETE CASCADE
